...
*Blunt*: (arrowhead) having a blunt, flat tip, designed to prevent penetrationoun
...
*Draught*: (of bow, arrow) amount or length drawnoun

*Draw, verb*: to pull back the string of a bow, usually for the purpose of shooting it.

*Draw, descriptionoun*: 1. act, manner, technique, of drawing; 2. distance between the back of a bow and its string at the moment of shooting (also called the bow’s *draw-length*).
...
*Hold*: to pause at full draw before releasingular
...
*Loose, nounoun*: act of releasing a drawn bowstring. Note: the word is often, but erroneously, used to denote the *Lock*.
...
*Recurve*: (in a bow) curvature in the opposite direction to that taken by the drawn bow.  Usually it denotes the end of a limb where the recurve can be either rigid or ‘working’ i.e.  losing some of its bend when the bow is drawnoun
...
*Sluggish*: (the loose) dead, i.e. slow with possible loss of tensionoun
...
*Stele*: synonoun with *Shaft*.

*String*: synonoun with *Brace*.

*Tang*: (of an arrowhead) the ‘tongue’, i.e. shank for insertion into the shaft.

*Target head*: arrow-head used for target shooting, ogival or triangular in silhouette, circular or polygonal in cross-sectionoun
...
*Tillering*: process of adjusting, with the aid of a tiller, the width and thickness of the limbs of a bow so that the correct curvature and balance may be achieved when the bow is drawnoun

*Tip*: (of a bow) extremity.

*War head*: arrowhead for use in war; commonly a triangular spike, square or triangular in cross-sectionoun
...
|--------|------------------------|---|----------|----------------------------|
|        |                        |   |          |                            |
|        |                        |   | q.verb   | quod vide (which, see)     |
| descr. | described, description |   |          |                            |
|        | discussed              |   | s.verb   | sub verbo (under the word) |
|        |                        |   | synonoun | synonymous                 |
|        |                        |   |          |                            |
|        |                        |   |          |                            |
|        |                        |   |          |                            |
...
*Adāra*: 1. to flex (the limbs of a bow to brace it); 2. to spin (an arrow horizontally on the finger-nails to test its shaft for trueness)

*Aflata*: 1. to loose, release (an arrow); by the end of the fourtcenth century the use of the verb in this sense was probably an archaism in Egypt and Syria; Ṭaybughā's verb is almost invariably Aṭlaqa; 2. to slip (the reins of one’s horse when shooting or about to shoot).

*Aḥwal*: 'askant, squint-eyed’, a method of binocular aiming.

*A'Immah*: see *Imām*.

*Ajrā*: ‘to run’ an arrow over some part of the thumb of the drawing hand (so as to give the arrow a natural guide (*majrā*) along which to travel at the loose).

*Akhaffa r-rijl*: to take one's weight off the [left] foot (in the flight shooting stance).

Akḥṭa'a: to miss the mark.

Aktāf(?): see p. 26 & discussion, p. 32.

‘Alāmah: mark at which to shoot.

‘Alī: ‘high’, deep (fletchings with reference to their extension outward from the shaftment); opposite Lāṭi'.

Amāj [Persian]: butt.

Amājiyyah, plural amājiyyāt: butt arrow.

'Amūd: stock (of a crossbow).
...
1113“AQARA (verbal noun 'AQR): to blister, cause blistering (an arrow to the thumb or index finger, a grip to the bow hand).

‘AQD: 1x. — (plural ‘uqtp): the lock, kind of lock, locking; see 'AQADA 4. & Ch. 10; kinds of lock explained in the Ghunyah are: AL-'A. AL-EAHRAMI, Bahrüm's lock (p. 53); AL~ KHUSRAWANI, Chosroes’ lock (p. 53); ‘A. AL-LUZÜM, the clinging lock (used to hold the shaft against the grip of the bow when nocking, p. 53); —— AR-RADIF, the pillion lock (p. 53); ~—— AS-SAQALIBAH, the Slav lock (p. 53); —— THALATHAH WA-SITTIN, the lock of ‘63’ (pp.  53» 54); —— TIS'AH. WA-SITTIN, the lock of ‘69’ (ibid.), etc. 2. the fingers of the drawing hand when locked on the string; 3. linear measure of very short (3 inoun or less), but indeter- minate, length.
...
1115ARKHA: is relax (transitive), hold loosely and without tension (any part of the body which should not be tensed in shooting).

ASABA: to hit (the mark), shoot accurately.

1116ASBAQ (comparative adjective): giving greater range (fletchings to arrows). Cf. SIBAQ.

ASBASALARI [Persian]: |commander's', name of an undefined type of arrow-guide,

1117ATLAQA: 1. to loose, release (an arrow, dart, bolt, etc); NOUNB. T rarely uses AFLATA, q.verb; 2. (of a horse) to give it its head.

ATRAD LI-S-SAHM: improving cast (a bowstring, thumb-guard, etc.). The use of this expression (compounded of comparative adjective of TARID, preposition, and noun) is very common,
...
1121 AWTARA; to brace, string (a bow). NOUNB.: not synonoun with WATARA (see MAWTOR).

AWWAL WAFA’: see Wara’,

1122AYMAN: ‘right-handed’, fletching with a natural curve to the right when viewed from the nock (Fig. 16). NOUNB.: in English practice T's right-handed feather would be described as left.  handed because of the different angle from which it would be viewed.

Aysar: ‘left-handed’, opposite AYMAN, q.verb

1123BA’, plural BA‘AT: spam of the outstretched arms, arm-span (almost 2 metres, See Appendix L).

BADAN: r. thickest part (of an arrowhead, shaft, etc.); 2. stele, shaft (of an arrow, bolt, ttc.).

1124*BADDADA: opposite JAMA'A, q.verb (Wadth, fo. 32a).
...
1127BansHAQ (on various spellings, etc., see Ch. 17, noun 16) [Persian]: a device for strengthening a point of weakness in the limb of a bow to make bracing possible. It appears to have been a ‘strap, cord’, possibly tied, or otherwise formed, into a loop, which could thus be slipped over the siyah and in some way tightened, (See pp. 93, 99.)

Bari (for Baqi): ‘slow’, an arrow failing to traverse about 75 yds. in less than 1} sec. (see Ch, 25, sect. 4 & noun 6); B. AL-ITLAQ: giving a slow loose (lock on a bowstring).

1128BATN, plural BUTÜN: r. (ofa bow) the belly, i.e, its concave surface when braced; 2. (of a feather) the ventral surface,

BATTIYYAH: a practice ‘drum’ used by the archer in training (discussed, p. 156).

1129BavAp: used absolutely (e.g. p. 122) or in adverbial phrases KASHF* L-B. (p. 128, etc.) and warA' p.  (p. 131) with reference to the attainment of maximum draught by an archer using a full-length arrow with the ‘greater draw" (NIHAYAH, q.verb); the term is fully discussed, pp. 127-29; B. AR- RIJL: instep,

BAYRAM SHAH [Persian]: ‘King Bayram’, name of an undefined type of arrow-guide.

1130Bayt: 1, —~ (plural BUYÜUT), limb of a bow (cf. Persian khdne~ye kaman ‘house of the bow’, i.c.  limb); AL-B. AL-A'LA, or B. AL-YAD, of B. AR-RAMY: the upper limb, as opposed to AL-B.  AL-ASFAL, Or B. AR-RIJL (Ot *B. AL-HATT, B. AL-ISQAT; sce Appendix 2); the lower limb; AL-B. AD-DA Ie: ‘the weak(er) limb’, said of the upper limb because, being the longer, it takes more bend than the lower, which is accordingly AL-B. AsH-SHADID: ‘the strong(er) limb’ (the term may, of course, refer to either limb if it is to be taken in its literal sense); z. ‘house’, holder in the nut of a crossbow for catching the string.

*BAZLAH: socketed head (? of a crossbow bolt 3 P. 30).

1131BIDÀYAH: the first ("starting point’) of three possible positions for the arrowhead at full draw, being that which affords its user minimum draught (discussed, pp. 127-29). Used absolutely, it is synonoun with ward’ 5. which may conveniently be translated as the ‘lesser’ draw.

BirjAs (PersianJ: a ring or hoop mounted on a spear for use in lance exercises, Under certain circumstances it may also have served as a target for archers in training. (See pp. 76, 83-84.)
...
1133CHANGAL-1 BAZ (? spelled jinkilbdz [Persian]): *falcon's talons’, manner of grasping, used in flight shooting (Fig. 20; p. 44; discussed, P- 46). i

CHILLaH [Persian with Arabic spellings jila, jila, chuld, etc.]: bowstring of silk twisted lengthwise from new, wound silk of high quality. ;
...
*Dawpay: (spelling—which is that given in Arab Archery—and etymology are uncertain, but it is possible that the word is düdan from Persian dé ‘two’ + -ddn ‘receptacle’, the reference being to some form of arrow-guide capable of projecting two darts simultaneously, Cf.  dudani, p. 29): name of a class of darts for use with an arrow-guide measuring about to inoun

1138DrsTGAH: see DastGAH,

DHANAB, plural ADHNAB: tail-feathers (used in fletching).

1139DHIRÀ': cubit, whence DH, AL-'AMAL AN-NAJJARL, of DH. AL-'AMAL LI-N-NAJJARIN, ‘the car- penters’ cubit', said by T to be synonoun with ADH-DH. AL-HASHIMI, ‘the Hashimi cubit’, a linear measure of 26-18 inoun (66-5 cm.). (See Appendix r.)

DIHĀN: (in manufacture) the process of painting the finished bow.

1140DiMAK [Persian ‘littie face'?] (or DAYMAK?): arrow-pass.

DIRHAM BI-D-DIMISHQI: ‘dirham, Damascus weight’, a weight of 47-6 grains (3:086 grams).  (See Appendix 1.)

1141*DÜDANi: see s.verb DAWDAN and p. 29.

DustTAr [possibly from Persian andákh (»andásh?) + -tår ‘that which throws, shoots’; cf. loss of an- in kushtuwan, q.verb]: 1. the working part of the limb of a bow (Fig. 5 & p. 11); D. AR-RIJL: the lower d.; D. AL-YAD: the upper d.; 2. loosely, the limb of a bow.

1142FAHLAH (from fahi ‘stallion, champion’, the feminine being best explained by assimilation to feminine noun  gaws, bow): ‘superb’, name of a Syrian war bow said by T to have been the best available in bis day.

FARAKA: I. to twist (the grip in loosing, arrow-guide in drawing, etc.); 2. to accomplish the loose with a farkah, q.verb
...
FtqQ, plural FUWAQ: nock of an arrow; synonoun with KAz (q.verb) except where it is necessary to differentiate between the nockpiece and the nock, in which case T clearly uses r. for the former and K. for the latter.
...
GHIZLAN: ‘gazelles’, name of an unidentified type of fletchings (p. 26; discussed, p. 32).

1148HapnaF, plural AHDAF: 1. target; 2. target face (as opposed to the target spot, gharad); 3. *AL-H, AT-TAMAM: ‘the full target’, a target at long range (284-328 yds.?); see p. 141.

HÁDD AN-NAFDAH BI-L-ITLÀQ: having a sharp, clean, loose (fight archer), (See Ch. r9, noun 6.)

1149Hapip: x. armour; 2. (collective, singular HADIDAH) arrowhead.
...
HALQAH: Ir. ‘curve’ to which a bow is bent in manufacture (p. 8) or in bracing; 2. —— (plural  HALAQAT: a loop of twine, used when folded in two around a bowstring as a holder from which to shoot a nockless arrow; 3. * (plural HALAQ) the rounded notch in the nockpiece of an arrow. (Sce p. 24 & Fig. 1 5.)
...
HAYDARI(?): ifa correct reading, the name of an unidentified type of arrowhead (see Ch, 5, noun 9). In the context the process of elimination leads us to suspect a hunting type, possibly a broadhead, in which case g. could be a copyist's error for jamwari ‘animal’ [adjective from Pers,
...
1158*HUSBAN (collective): x. ‘hailstones’ (?), name of darts about 15 inoun long; 2. a kind of arrow-guide for the projection of such darts 3 see p. 150.

IBRANJAK (*alsa IBRANJAQ; IFRANJAK in the Wadih) [Persian abranjan +. -ak "little bracelet’?]: I, a roughly semicircular Strip, or sliver, of hard material (hardwood, bone, etc.) running round the belly of a bow's grip and filling the gap left in manufacture between the upper and lower sections of horn lining (see p. 14); it is the Turkish chekk ; 2. loosely, the belly of the
...
1161IDTARABA: 1. to flirt (intransitive verb, an arrow); 2. to go out of control (a bow when loosed); 3. I. Fi JARYIHI: to gallop uncollectedly (a horse).
...
IKHTALASA: to snatch, use the snatched loose. NOUNR.: T’s snatched loose (mukhtalas) differs from that of Mustafa Kani (ikhtilās). (See detailed disc’n, pp. 66-67.)
...
IMAM, plural A'IMMAH: in the Ghunyah, an imam of archery is the supposed founder of a system of shooting. On the four accepted systems, see Ch. 23.

1166IMTATTA: to stretch (intransitive verb, a bowstring under the tension of a braced bow).
...
INQILAB: 1. 1. AL-QAWS: the sudden and violent accidental reversion of a bow to its unbraced State; 2. I. AL-FISAD: ‘inversion of the cupping-point’, the fault of allowing the left elbow to curve inwards towards the path of the string (discussed, p. 120); on variants, etc., see Ch. 21,
...
1171IsHTADDA: (with reference to shooting technique) to be tensed, be in a state of tension (a part of the body).
...
Isriva’: verbn, of ISTAWFA, q.verb
...
ITrMÁD: verbal noun of I'TAMADA, q.verb

1175ITLAQ (verbal noun of ATLAQA): 1. act of loosing, releasing (an arrow), the loose; 1. As-SUKÜN: the held loose, otherwise termed SAKIN, q.verb ; SALAMAT AL-I. ‘sound quality of the loose’, i.e. a clean loose; 2. (plural ITLAQAT): manner, way, of shooting.

JABBADH: drawing-strap (Fig. 29).

1176JADHABA: to draw (a bow). T has a marked tendency to use this verb in contexts in which he is not primarily concerned with shooting, but with the testing of equipment, questions of traction, etc, (cf. JARRA & NAZA'A). See MADDA,

Jarasa (verbal noun JULUs): to adopt a squatting, or half-kneeling, half-squatting, position (jalsak), from which to shoot.
...
Jam’ (also Jami‘) (verbal noun of JaMa‘A): grouping, good grouping (of arrows in a target). (Sce p. 156.)
...
1180 JaRAD (coll): 1. ‘Locusts’, name of a class of darts for use with arrow-guide and ranging from 2j inoun to 73 inoun in length; 2. name of an arrow-guide (from which, presumably, the latter were shot).

JankH [Persian charkh]: a type of crossbow fitted with a stirrup (in A! only; in all other manuscripts Jarkh is replaced by gaws ar-rijl, ‘crossbow’; see p. 19). Although the connexion with the basic meaning of the Persian charkh, ‘wheel’, has puzzled scholars (see Huuri, Gesch., pp. 94- 95), it should be noted that one simple method of drawing a medieval crossbow consisted in using a straightforward pulley mechanism which entailed the use of a small wheel (Fig. 11).

1181JanMaki (?) [Arabic adjective in -i from Turkish adjective çarpık (>jarbak) 'awry'?]: name ofa form of shooting from horscback in which the archer, having the bowstring on the inside or outside of his bow-arm, anchors in the nape of the neck. See pp. 75, 82.

JARR (verbal noun of JARRA): E. act of drawing a bow, arrow, etc. 3 sec JARRA; 2. draught (MIN AS-SAHM, permitted by the arrow).
...
JULUSs: verbal noun of JALASA, q.verb
...
KAMINDAN, KAMINDANAH [Persian]: bowcase (T's regular term is tirkash).

1190Kanar [Persian]: the dividing edge separating the back of the bow from the belly. (See Fig. 54)

KASHF? (L-)eAvAp(adverbialphrase): (w.ref.to an arrow at full draw)to the limit of the *greater draw (on which, sce BAv&p and NIHAYAR).

1191KavvazA: to nock an arrow. E

Kàz, plural KĀZĀT (Turkish]: nock of an arrow; synonoun with fag, except where there is need to distinguish between nockpiece and nock, in which case T clearly uses fag for the former and K. for the latter, -

1192KHAM[Persian]: x. raw (silk); 2. unbored (that part of the tang’s socket in thc arrow-shaft which is not prepared prior to the fitting of the arrowhead); 3. unfinished (bow in manufacture when ready to be strung for shaping to the desired curvature, but not yet veneered and painted).
...
1194 KHARKUMAN [Persian khar — Ramdn?]: bracing-board.

Kuart (?): an unidentified type, or quality, of arrow. (See Ch. 5, noun 6.)

1195KHARTUM, KHURTÜM; a long horn ciip fitting over the nut of a crossbow.

KHASHAB (collective wood^): 1. (of the bow) wooden core (as opposed to sinew backing and horn lining); 2. (of the arrow) shaft; 3. (of the gabag, q.verb) mast.
...
1197KHATARA: to follow through with a kkagrah, q.verb
...
KirAyaH: of three possible positions for the arrowhead at full draw, that which lies between BIDAYAH (q.verb) affording minimum draught, and NIHAYAH (q.verb) affording maximum

1201 draught.  KuLLAB: hook (of the claw of a drawing-strap).  *KusHTIBAN, ——- UBAN, KUSTIBAN, —— UBAN: see KUSHTUWANOUN


KUSHTUWAN, plural KUSHTUWANAT (other forms as indicated above) (Persian angushivan}: 1. archer’s thumb-guard (leather); sec pp. 34-35 & Fig. 17; 2. archer’s drawing-ring (bone, horn, metal, etc.); see pp. 34-36 & Plate 7.
...
La'ABA (verbal noun LA'R): to wag (intransitive verb, an arrow).

1203La'B AL-UKRAH: polo.

LAKZAH: a ‘punch’ to the rear with the right elbow at the instant of loosingular (See p. 65.)

1204LagsHAH: name of an unidentified type of Maghrebi crossbow.

Lata’: [ow trajectory (of an arrow).

1205Làri (for LATU): 1. ‘iow’, shallow (fletchings with reference to their extension outward from the shaftment); opposite ‘ALI; 2. having a low trajectory (arrows); opposite MURTAFT.
...
LigAM (masculine singular): horn lining (of the belly of the bow).

1207LUZUM: see 'AQD AL-LUZÜM.

Mapp (verbal noun of MADDA): the act of drawing a loaded bow with the intention of shooting, the draw (see MADDA); AL-M. AL-JUWWANI: the ‘internal’ draw, i.e. the act of drawing the string closely along the inside of the left arm and then sharply deflecting the path of the drawing hand across the face (see p. 120); AL-M. AT-TAMAM, AL-M. AT-TAMM: the completed draw; scc also s.verb WAFA'.

1208 186 ARABIC-ENGLISH GLOSSARY


Mappa: to draw in the sense indicated s.verb Mapp. It is worth noting that where the emphasis lies on drawing from the point of view of testing a bow or considering problems of traction, T tends to use some other term such as JADHABA, JARRA, etc. ; M. S-SAHM ZA'ID?^: to overdraw.

1209MAFRÜK: ‘twisted’, said of the loose, meaning most probably that it was accomplished with a FARKAH, q.verb (See disc’n, pp. 66-67.) NOUNB.: the term does not have the same technical sense as in Arab Archery or the Telfis (under the form mefrith).
...
MaQBAD: x. —— (plural MAQABID): the handle, grip (of a bow); rarely used by T, who prefers QABDAH, q.verb; 2. that portion of the handle which is gripped by the little finger, ring-finger, and middle finger.

1214MARMA: a shooting range.

MASIR AS-SAHM: range attained by an arrow.

1215MASKAH; the particular manner in which an arrow is taken up, grasped, removed from the quiver, etc., prior to nocking. NOUNB.: grasping in this sense is not covered by QABDAE, which relates only to the bow.
...
1217MAWTÜR: having the bowstring in place (the nock of an unbraced bow). NOUNB.: it does not mean ‘braced’,

MaYDÀN, plural MAYáDIN (or colloquially, MAWADIN): a field, or ground, set aside for military training, exercises, displays, etc.; *AL-M. AT-TAWIL: long-range target (284-328 yds.?).  (See p. 141.)

1218MayDANi: ‘for shooting in the maydan’, adjective used to distinguish (a) the target arrow from the war arrow, the flight arrow, etc. ; (b) the head of the target arrow from the warhead, etc. The head appears to have been circular in cross-section and it would have been tapered to a point. (See p. 26.) aT

MAYDANIYYAH, plural MAYDANIYYAT: a maydani arrow; the plural is synonoun with NUSHSHAB MAYDANi.  (See p. 28.)
...
Mijrar, plural MAJARI: arrow-guide; to all intents and purposes synonoun with MAJRA, q.verb, though it seems possible that the latter applied to the simpler forms of guide and M. to more elaborate devices such as the M. AL-KHURTUM (‘long-nosed’ arrow-guide; Fig. 50, descr.  p- 146) or M. AR-RIKAB (stirrup-guide; Fig. sr, descr. pp. 146-47), etc.
...
1222Mv artum: synonoun with USTÀD, q.verb
...
MyUHARRIF: having, or putting (oneself, one’s grip on the bow) in the oblique positionoun See HARRAFA.

1224MUKHTALAS: ‘snatched’, name given to a form of loose (descr. p. 645 discussed, pp. 66-67).
...
MUNFASILAH (sc, gaws): ‘comprising separate elements fitted together’, almost certainly the old Arabian composite bow; said to be synonoun with WASITIYYAH, q.verb
...
MURRAN; Cornus mas (wood used in old Beduin Arab bows and said to be synonoun with shawhat).

1230MURTARY: having a high trajectory (arrow); opposite LATI.

MURTARHĪ: ‘loose, slack’, not bent to the bridle (a horse’s neck).

1231Musappar: thick in the foreshaft (sadr). NOUNB.: the meaning is different from that given in Arab Archery, p. 106, where this term is rendered ‘barrelled’ and denotes two kinds of arrow: (a) that of which the first third is thin, the second thick, and the final third thin like the first; (b) that of which the first half is thin and the second thick as far as the fletching. T leaves no doubt as to the meaning it had for him (p. 24).
...
1237MUTAWAJJIH: facing squarely, directly (as opposed to turning sideways), being in, or adopting, the frontal (as opposed to oblique) position (the archer in addressing himself to the mark; See pp. 101-2); cf. MUWAJJIH; opposite MUHARRIF.
...
MuwajypH: adopting, being in, the frontal positionoun The word is more usual than, but virtually synonoun with, MUTAWAJJIN, q.verb

1239Nab‘: Grewia poplifolia (not Chadara renax), name of a wood used by the Arabs from early times for self bows.

NaBr (coll), singular NABLAH: x. darts designed to be shot from a hand bow with the aid of an arrow-guide; 2, crossbow bits, NOUNB.: unless he quotes, T does not use the term at all to denote ordinary arrows.
...
1241Nast, plural NUSUL; arrowhead; NUSUL AL-AHDAF, Singular NASL AL-HADAF: target heads.
...
1242Nazar (verbal noun of NAZARA, Qq.VERB): act of sighting, aiming; AN-NOUN AD-DARHIL, or MIN DAKHIL: internal sighting, sighting from inside the bow (see NAZARA); AN-NOUN AL-KHARIT, OT MIN KHARIJ : externa! sighting outside the bow (see NAZARA).

NAZARA; to sight, aim, take aim (ILA at): T’s almost exclusive use of this term in preference to the more usual :"tamada of earlier and more conventional authors is striking and suggests that the latter was an archaism in his day and area; NOUN MIN DAKHIL AL-QAWS: to sight, aim, from inside the bow (p. 62) by aligning the arrowhead with the mark and training one’s sight on it along the shaft, thereby directing the line of vision from the left of the drawn string to the right of the grip and Causing it to pass between bow and string (Fig. 24); NOUN MIN KHARIf AL-QAWS: to sight, aim, from outside the bow (p. 61) by training one’s sight on the mark along the back of the bow hand, the line of vision thereby running from the left of the string to the left of the grip without passing through the bow and the string (Fig.  24); NOUN BI-QISMAT AL-'AYNAYN: to sight, aim, with split vision (p. 62), by training the right eye on the mark along the shaft and the lcft along the back of the bow-hand.

1243NiHÀYAH: of three possible positions for the arrowhead at full draw, that consistent with the maximum draught, Used absolutely, it is synon, with wari’ NOUN, which may be conveniently translated as the ‘greater draw’ (disc’d; pp. 127-29).
...
1244Nüm: (of the eyes) line of visionoun .

NusHsHá (coll, singular NUSHSHABAH): arrows as opposed to darts and bolts. NOUN TAWIL: ditto (sce TawiL, 1, and SAHM TAWIL).

1245 ARABIC-ENGLISH GLOSSARY 189


Qa‘ava (verbal noun QUUD): synonoun with JALASA, q.verb

1246Qa"ADA: to set in true (the szyaks of a bow after bracing to correct lateral distortion).

QABADA (verbal noun QABD): to grip, grasp (a bow, in the sense of arranging the fingers and thumb around its grip, or handle, in the manner in which they are to be disposed when shooting).

1247Qanaq [Turk, kabak ‘gourd’]: 1. principally, an elevated target, such as a gourd or suitable substitute, affixed to the top of a mast as a mark for horse-archers (detailed disc'n, pp. 77-78 & Appendix 6); RAMY AL-Q.: I. military exercise in which horse-archers shot at the kind of target indicated; 2. the act, technique, of shooting upwards (from horseback as in the exercise); opposite QIGHAJ, q.verb

QaBDAH: 1, —— (plural QABADAT, QIBAD): grasp, mode of gripping a bow: see QABADA; 2. bow- hand; 3. fist of either hand; 4. muscle under tension in the forearm; 5. linear measure of about 33 inoun; 6. —— (plural QIBAD): grip, handle of a bow. Sec also MaQsAp.
...
QasiR: short (arrows); explanation s.verb SAHM; TAQSIR AL-Q.: sce "T'AQsIR; TATWIL AL-Q.: see TATWIL.

1251Qaws, plural QISTYY, also AQWAS: bow; Q. AL-JARKH: see JARKH; Q. AR-RIJL: crossbow (see p. 18); Q. AS-SABQ, Q. AS-SIBAQ: flight bow; Q. AL-YAD: band bow (used in cases where it is necessary to differentiate between the ordinary bow and the crossbow). See also s.verb FHJAZIYYAH, MASNÜ'AH, MUNFASILAH, MURAKKABAH, WASITIYYAH.

QicHaJ, Qiqay [Turkish Aag ‘slope’]: inter alia (detailed disen, pp. 78-79 & Appendix 6) RAMY AL-Q. denotes: X. a military exercise in which horse-archers shot at a butt or other ground target along a line of flight parallel to the left thigh; 2. the act, technique, of shooting downwards at any angle.

1252QinAT: linear measure of about 1-1 inoun (See Appendix 1.)

QIvAM: stance, standing position from which to shoot (as opposed to JULDs, Qu'UD, q.v); Q. RIJL AL-QAWS: a fault in a bow whercin the strength of the lower limb is greater than that of the upper (discussed, p. 121).

1253Quepap (singular QABID2): fingers of the bow-hand with which the handle of the bow is gripped (in T the little finger, ring-finger, and middle finger).

Qu'üb: verbal noun of QA'ADA, Q.verb
...
1256*Ràjp': (intransitive) recovering, having recovered (a bow in its unbraced form or  reverting thereto).

Rama (verbal noun Ramy): 10 shoot ('ALA, “AN QAWS, a bow).

1257RAMI,plural RUMAT: archer.

Ramy: shooting, archery (often R. BI-N-NUSHSHAB); R. AL-AHDAF: target shooting; R. AS-SABQ, R. AS-SIBAQ: flight shooting. Sce also s.verb QazaQ, QicHay.
...
1259Raqip: held in a horizontal position (a bow); opposite WAQIF.
...
Rygr: lower limb (of a bow). For synonyms, see s.verb BAYT, DUSTAR.

1263*RIKAB: used absolutely for QAws AR-R. See Pp. I9, 29, 88

RIMAYAH: R. BI-S-SIHAM: archery (for which the usual term in the Ghunyah is RAMY, q.verb).
...
SABQ (verbal noun of saBAQA): flight shooting; synonoun, for all practical purposes, with SIBĀQ, q.verb  hence QISIYY AS-S.: bows for flight shooting, flight bows, etc.

1267SABQIYYAH, plural SABQIYYAT: flight arrow. See detailed study, pp. 105-10.

SADR: foreshaft (of an arrow). NOUNB.: nor the part from the shaftment to the middle of the shaft as in Arab Archery, p. 103.

1268SAFIHAH, plural SAFA'TH: lamina (of a brigandine).

SAHM: I. (plural SIHAM): arrow; S. TAMAM: a full-length arrow (30 in, in the case of the maydani and slighty less than 29 inoun in the case of the war arrow); s. TAWIL: ‘long arrow’, arrow designed for normal use with a standard hand bow and so called where there is need to distinguish from s. QasiR, ‘short arrow’, i.e. any arrow or similar missile such as a dart or bolt designed to be drawn and shot from inside the grip by means of an arrow-guide; S. AL-MÜS: razor arrow (so called from a razor edge concealed in the nock (Fig. 47; descr.  p. 138, discussed, p. 142); s. AS-SIBAQ: flight arrow (synonoun with sagQrvvau). 2. *shaft (of a bolt); 3. lathe, prod (?; of a crossbow). (See Ch. 4, noun 8.)

1269SA'IB, plural sawa’IB: an arrow that hits the mark, marksman’s arrow, accurate shot.

Sap: side of a stirrup.

1270SAKANA (intransitive verb): to hold (by pausing at the draw immediately prior to loosing). See SAKIN, 2.

SAKHKHANA: to apply heat treatment (to a bow). See TasKHINOUN

1271SAKIN: r. immobile, still (with reference to points of stillness, i.e. those parts of the body which the archer must keep absolutely motionless when shooting); 2. held (describing a form of loose in which the archer pauses, or holds, at full draw before releasing; descr. p. 64; discussed, p. 66).

SAKKANA (transitive verb): to hold (synonoun, for all practical purposes, with SAKANA, q.verb).
...
1273SaLiB: heavy (with reference to draw weight, a bow); opposite LAYYINOUN

SARI: s. AR-RUJŪ‘: see RAJA'A; S. AT-TARJÍH: see Tarjinoun ,
...
1277SAYSARAH (or SISARAH?) [Persian?]: in the contexts in which it occurs s. seems to indicate some kind of protective covering; hence we suggest: 1. protective covering, probably of leather (see p. 94), to safeguard the loop of the bowstring against chafe at the point where the loop fits into the bow’s nock (p. 20); we know of such a covering on a Persian (eighteenth- century?) bowstring; 2. the lip of a leather thumb-guard protecting the pad of the thumb (p. 34).
...
Suapip: 1. powerful, heavy (a bow); opposite LAYYIN; 2. tensed (w, ref. to points of tension, i.e.  thosc parts of the body which the archer must tense when shooting); opposite LAYYINOUN
...
1281SHAQQ: X. —— (plural sHUQUQ): splitting, split (of skin or nails as a result of injury caused by faulty shooting technique); 2. slot (in a cylindrical arrow-guide; see p. 145).

*SuARIJ: a self bow consisting of a single split lengthwise, (See p. 10.)

1282SHARRABAH: tassel (fitted to an arrow-guide, a JULBAH, q.VERB, OF similar aid, to prevent it from falling out of the hand at the loose).

SHAWHAT: a wood said to be the same as Cornus mas.

1283SHIBR: span, linear measure of—in our view—-about 73 inoun (See p. 29.)

SiBAq (verbal noun of SABAQA): flight shooting (in which archers compete for distance); used either absolutely or in the full expression RAMY A$-5, “ALA BU'D AL-MASAFAH. S. and SARQ arc, for most purposes, synonymous. Inherent in the root SBQ is the notion of getting ahead, and, in the sphere of archery, it has reference not to speed, as in racing (also s.), but to distance.  Strictly speaking, s. differs from saBQ in that the latter means purely and simply ‘getting in front of’, while s. brings out the competitive element, ‘competing with another/others in an attempt to outdistance him/them", or the like. See Ch. 19 for full explanation of flight shooting.
...
1285*Srper [Persian]: ‘shield’, a grooved horn shelf, or guide, strapped to the hand of an Ottoman flight shooter, to enable him safely to bring his arrow well inside the grip. (See p. 106.)

Sreirsar (Persian sar afsdr, *head-stall']: martingale (discussed, p. 79)- í

1286SISARAH: see SAYSARAH. ;

SIYAH, plural SIYĀT (consistently pointed as SIYYAH, -At): (of the limb of a bow) the relatively inflexible extremity which serves as a lever during the draw (Fig. 7; pp. xxviii-ix); AS-5.  AL-'ULYÀ, S. AL-YAD: the upper siyah, that of the upper limb; AS-S. AS-SUFLA, S. AR-RITL: the lower siyah, that of the lower limb.

1287SUKÜN (verbal noun of SAKANA): r. the act of holding (see SAKIN, 2); ITLAQ as-S.: the held loose (see SAKIN, 2); 2. state of stillness (in parts of the body; see SAKIN, 1). i

Su'Üp as-SAHM: the angle of ascent of an arrow.

1288*Tappip: bad grouping (of arrows in a target); Opposite JAM".

TapMik: (of an arrow leaving the bow at the loose) the act of slapping the arrow-pass (DIMAK) with consequent deflectionoun
...
TAHLIL: verbal noun of HALLALA, q.verb

1291TaHRir: 1. verbal noun of HARRAFA, q.verb; 2. (used absolutely with reference to the way in which the archer addresses himself to the target) the sideways, or oblique, position, c.g. QU'UD AT-T, the act of squatting in the oblique positionoun (See p. 122 and Fig. 42 (stancc).)

TALQ (verbal noun of TALAQA): synonoun with ITLAQ, q.verb, the latter representing, presumably, strict literary usage and the former the colloquial.
...
TAQŞĪR aL-Qasir: ‘shortening the short’, (with reference to the lock, p. 53) slight retraction, from the recommended normal position, of the distal phalanx of the thumb as it rests beneath the index finger; cf. Tagsir AT-TAWIL which is illustrated in Fig. 21e.

1295TaQsIR AT-TAWIL: ‘shortening the long’ r. (with reference to the lock, p. 53) slight retraction, from the recommended normal position, of the index finger as it rests on the distal phalanx of the thumb (see Fig. 21, comparing (e) with (a) ); 2. (with reference to the bow-hand, p. 123) slight retraction of the fingers to allow the archer to grasp squarely as he would certainly Wish to if, for instance, the Brip of a bow were too thin for his normal grasp.
...
1297'TARBI: opposite of TAHRIF, q.VERB, and, with reference to the way in which the archer addresses himself to the target, synon, with TAWJIH, q.verb, though much less commonoun

*Tampir: synon, with RADIF in the phrase 'AQD AR-RaDIF. See ‘Agp.

1298TARID LI-S-SAHM: giving, resulting in, good cast (use of a particular technique, item of equipment, etc.).

TARJĪH (verbal noun of RAJJAHA, to cause to outweigh); SARI'AT-T., said of a bow, means that it has speed of recovery, i.e. it is quick (sari) to make its limbs ‘outweigh’, or overcome, the pull exerted during the draw and, by springing forward in the direction of their natural pull, regain the position they had before the braced bow was drawnoun

1299TAR (verbal noun of TARAQA): (with reference to the action of the bowstring) rapping (of fingers, etc. as a result of faulty technique).

TaskHIN: the application of heat treatment (to a tow). Full details, pp. 99-100.

1300Tasma [Persian tdsmah]: leather band (on bowstring to protect the nocking point? Sec p. 140).

Taswis (?) AS-SAHM: the act of causing an arrow to fly too low (?). See detailed disc’n, p. 120.

1301TaTRIF: (with reference to the lock) the act of putting only the tip of the right index finger on the distal phalanx of the thumb (sce MuvTAnRAF). This action amounts to excessive ‘shortening of the long’ (see TAQSIR AT-TAWIL). —

TATWIL AL-QaSIR: "lengthening the short, r. (with reference to the lock, p. 53) slight projection, beyond the normal recommended position, of the thumb as it rests beneath the index finger (cf. TAQSIR AL-QasIR and TAQsIR AT-TAWIL); 2. (with reference to the bow hand, p. 123) slight exten- sion of the fingers to allow the archer to use the oblique grasp; opposite TAQSIR AT-TAWIL, q.verb

1302TaTWIL AT-TAwiE: ‘lengthening the long’, (with reference to the lock, p. 53) slight projection, beyond the normal recommended position, of the index finger as ít rests on the thumb with the result that the middle phalanx of the finger lies wholly on the thumb-nail.

Tatwiz: (in manufacture) the process of veneering the bow with raz [Persian], or bark, prior to finishing with paint.

TAWAJJAHA: to face (ILA towards, the mark) squarely, directly (as opposed to adopting the sideways position). (See p. 102.)

1304TAWAJJUH (verbal noun of TAWAJJAHA); the frontal, directly facing (as opposed to sideways), position (see p. 102); synonoun with Tawyist and, morc rarely, TARBÍ'.
...
1305TawjiH (verbal noun of WAJJAHA): the frontal position (adopted by the archer in addressing himself to the target); used absolutely; synonoun with TAWAJJUH, Q.VERB

Tawof' (?) AL-LIHAM: (in manufacture of the bow) an expression which, on the basis cf context, etc., would appear to denote the process of fitting (in sense of shaping and adjusting) the horn lining (lihdm) to the wooden core with which it is to be bonded to form the belly of the finished weaponoun It would be attractive to read targ , ‘grafting’, for cawgi’ of the MSS, but we see technical objections. Likdm admits of no doubt; it occurs in many works with the sense indicated.

1306*TAzLiQ: act of following through by causing or allowing the bow-hand to go forward in a smooth gliding movement.

Taznip: distressing contusion of the wrist (?) or, the fault of striking the wrist. (See Ch. 20, noun 5.)

1307THABATA: to settle to the string (‘ALA L-WATR; bow after bracing).

THABIT: settled (bow to the string).

1308TIRKAsH [Persian]: quiver, bowcase.

ULKI [Turkish iii, ‘target’]: *a target at long range (130-150 arm-spans). In our Ghunyah the term is qualified in the expression AL-U. AL-QASIR which we take on empirical grounds to be a short-range target in the order of 75-80 yds. (See disc’n, p. 141.)

1309‘Una, plural a‘NAQ: (of the bow's limb) the ‘neck’, that point at the end of the working limb where the siyah (q.verb) begins, or, in other words, the root of the siyah. (See Fig. 5.)

*UqpAH, plural'UQAD: 1. (of the finger) phalanx (nor joint, mifsal);  2. protuberance, meaning, in

1310_ the expression ‘U. AL-ASABI’, the knuckles.

ÜorvvaH: a weight of 3z of a RATL, q.verb

1311*Unwau: loop (of a bowstring).

Usráp, plural UsSTApUN: a master (archer, bowyer, in the hierarchy of professional organization ; see pp. 123, 155).
...
Wayx: the belly (of a bow or its grip}; synonoun W. BATN, q.VERB5 OPP- ZAHR.

1313Waotr: held in a vertical position (a bow); opposite RAQID.

NVASITIYYAH (not "from Wasit’): the intermediate bow—probably so called from the point of view of construction and relative proportions which we take to be the old Arabian com- posite (see p. 10); said to be synonoun with MUNFASILAH.

1314WATR, plural AWTAR: bowstring; W. AS-SIBAQ: string for use with a fiight bow.
...
WAZN: vnoun of WAZANA, 3.

1316 194 ARABIC-ENGLISH GLOSSARY


WAZN, plural AWZAN: X, weight (of arrows, in usual sense of mass); 2, thc centre of gravity (of an arrow); 3. verbal noun of WAZANA 3.

1317YAD: =z. (of the body) arm (as opposed to hand, kajf); 2. the upper limb (of a bow). For synonyms, scc BAYT,

YAGHLIQ [Turkish ? yağı, ‘enemy’ + -lik?]: war arrow (details, PP- 25, 28 & Appendix 2).

1318Y&MUR: ibex horn,

Yasr (Persian]: type of arrow with a sharp head, possibly a broadhead.

1319ZAHR, plural ZUHÜR: 1, (of a bow) the back, i.e. its convex surface when braced; 2. (of a feather) the dorsal side, i.e. its outer surface; 3. (of the dorsal surface of the bow's grip) the spine, i e.  the longitudinal line dividing the surface.

ZANBURAK [Persian ‘little wasp’]: undefined type of crossbow. Sec pp. 8, 19.
...
1322ZURQAH: light bruise, blueness, caused by bruisingular
