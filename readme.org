...
- [-] PAIN
  ...
  - [-] Chapter 4
    - [X] Text
    - [ ] Conversions
    - [ ] Finish parts I was too frumpy to finish at the time.
  - [-] Chapter 5x
    - [X] Text
    - [ ] Conversions
  - [X] Chapter 6
  - [ ] Chapter 7
    - [ ] Revise changes that I made towards the end, as I was probably grumpy and removing text to make it easier to edit.  There may be something of interest in the laboriously explained text that I culled.
  - [-] Chapter 8
    - [X] Text
    - [ ] Conversions
  - [X] Chapter 9
...
- [ ] Make a minimal [[https://pandoc.org/MANUAL.html#epub-styling][.css file]].
- [ ] Double-check pronunciation guide.
- [ ] Run a spell check over everything, after having deleted custom dict.
- [ ] New images, like, every-fucking-where.  Fuck.  Appendix 5 references plate 18 (reproduction of Taybgha's bow) and if I only include one set of pics, it needs to be this one.  Oh, and finger-counting.
...
- [ ] Videos?
- [X] Lookup [[https://pandoc.org/MANUAL.html#epubs][ePub extras provided by Pandoc]], "index/forward" etc.
